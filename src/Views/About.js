...
<div class="w3-container" style="padding:128px 16px" id="work">
  ...
  <div class="w3-row-padding" style="margin-top:64px">
    ...
    <div class="w3-col l3 m6">
      <img src="https://www.noncopyright.com/wp-content/uploads/2018/07/Tilted-iPhone-8-MockUp-1280x720.png" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="A phone"/>
    </div>
    <div class="w3-col l3 m6">
      <img src="https://lh3.googleusercontent.com/proxy/brX8e-crjAcd0jD8OzOvTmR2vYfLxt4zSPZCzvZl036ynxk4dyckBUBIK8rXD_a9XYgPmhA1NThuM8_6v7iHEZ4g4JNidXJ4TPoJqYNHgVS5m-N3SNLDLfZgsMGvmvWNMnI" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="A drone"/>
    </div>
    <div class="w3-col l3 m6">
...
<div class="w3-container w3-light-grey" style="padding:128px 16px" id="contact">
  ...
  <div style="margin-top:48px">
    ...
    <img src="/w3images/map.jpg" class="w3-image w3-greyscale" style={{width: '100%', marginToop: '48px'}}/>
  </div>
</div>
